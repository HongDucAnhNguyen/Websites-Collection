...
const OurMissionSection = () => {
  return (
    <Box bg="black">
      <Layout>
        <Flex gap={20} className={styles.aboutUsStoryAndMissionSections}>
          ...
          <Box maxWidth={400}>
            ...
            <Text mt={5} color="white" fontFamily="Open Sans" fontSize={18}>
              ...
              invite you to savor unforgettable moments at LeClaire, where every
              meal is a celebration of culinary mastery.
            </Text>
            <Link href="/menu">
              {" "}
              <Button
